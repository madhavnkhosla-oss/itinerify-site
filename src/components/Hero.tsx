    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 py-20 text-center text-white">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in">
          Welcome to <span className="text-gradient">FitGrouper</span>
        </h1>
        <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-95">
          Professional group fitness classes for residential communities. Expert coaches, flexible scheduling, seamless management.
        </p>
      </div>
